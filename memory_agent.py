...
system_prompt = """
You are a helpful AI assistant named Tony.
...
print("Agent name: Tony")
print("Personality: Friendly and concise")

# This is what memory looks like
example_memory = [
    {"role": "user", "content": "My name is Pracheth"},
    {"role": "assistant", "content": "Nice to meet you Pracheth! How can I help you today?"},
    {"role": "user", "content": "What is my name?"},
    {"role": "assistant", "content": "Your name is Pracheth, you just told me!"}
]
...
# Message 1
question1 = "Hi! My name is Pracheth and I am building an AI agent."
print("You:", question1)
...
print("Tony is ready. Type 'quit' to exit and save.\n")
...
while True:
    ...
    if user_input.lower() == "quit":
        save_memory()
        print("Tony: Goodbye! See you next time.")
        break
